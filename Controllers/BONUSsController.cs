...
namespace HRM.Controllers
{
    public class BONUSsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BonusID,BonusName,isFreedTax,TaxFreeValue")] BONU bONU)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BonusID,BonusName,isFreedTax,TaxFreeValue")] BONU bONU)
        {
            if (ModelState.IsValid)
            {
